...
{
    public class AddModifierExpression : BinaryExpression
    {
        public AddModifierExpression(IExpression arg1, IExpression arg2) : base(arg1, arg2)
        {
        }
